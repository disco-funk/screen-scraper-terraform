...
output "vpc_endpoint_sqs_id" {
  ...
  value       = concat(aws_vpc_endpoint.sqs.*.id, list(""))[0]
}
...
output "vpc_endpoint_ecs_id" {
  ...
  value       = concat(aws_vpc_endpoint.ecs.*.id, list(""))[0]
}
...
output "vpc_endpoint_ecs_agent_id" {
  ...
  value       = concat(aws_vpc_endpoint.ecs_agent.*.id, list(""))[0]
}
...
output "vpc_endpoint_ecs_telemetry_id" {
  ...
  value       = concat(aws_vpc_endpoint.ecs_telemetry.*.id, list(""))[0]
}
